...
class MLP_EKF_ReTraining:
    def __init__(self, model_dims=[2, 16, 16, 1], prior_var=0.1, dynamic_sigma=1e-4):
    ...
    def run_mlp_ekf(self, output, inputs, initial_mean_rot, initial_covariance_rot):
        ...
        cmgf_ekf_post_rot = conditional_moments_gaussian_filter(cmgf_ekf_params, EKFIntegrals(), output, inputs=inputs)

        return cmgf_ekf_post_rot
